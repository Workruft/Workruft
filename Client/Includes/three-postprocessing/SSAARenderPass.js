...
let SSAARenderPass = function ( scene, camera, clearColor, clearAlpha ) {
...
SSAARenderPass.prototype = Object.assign( Object.create( Pass.prototype ), {
	...
	render: function ( renderer, writeBuffer, readBuffer ) {
		...
		let jitterOffsets = SSAARenderPass.JitterVectors[ Math.max( 0, Math.min( this.sampleLevel, 5 ) ) ];
		...
		let width = readBuffer.width, height = readBuffer.height;
