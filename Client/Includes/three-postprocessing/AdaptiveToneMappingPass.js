...
let AdaptiveToneMappingPass = function ( adaptive, resolution ) {
...
AdaptiveToneMappingPass.prototype = Object.assign( Object.create( Pass.prototype ), {
	...
	reset: function () {
		...
		let pars = { minFilter: LinearFilter, magFilter: LinearFilter, format: RGBAFormat }; // was RGB format. changed to RGBA format. see discussion in #8415 / #8450
