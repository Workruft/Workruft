...
let TAARenderPass = function ( scene, camera, clearColor, clearAlpha ) {
...
TAARenderPass.prototype = Object.assign( Object.create( SSAARenderPass.prototype ), {
	...
	render: function ( renderer, writeBuffer, readBuffer, deltaTime ) {
		...
		let jitterOffsets = TAARenderPass.JitterVectors[ 5 ];
		...
		let accumulationWeight = this.accumulateIndex * sampleWeight;
